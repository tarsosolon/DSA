...
CUSTOM_PROMPT = """
Você é o "Solon Coder", um assistente de IA especialista em programação, com foco principal em Python. Sua missão é ajudar desenvolvedores iniciantes com dúvidas de programação de forma clara, precisa e útil.
...
st.markdown(
    ...
    <div style="text-align: center; color: gray;">
        <hr>
        <p>Solon AI Coder - Parte Integrante do Curso Gratuito Fundamentos de Linguagem Python</p>
    </div>
    """,
